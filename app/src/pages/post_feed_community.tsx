...
const NavStyle = styled(NavBar)`
  z-index: 9999; /* Set a higher z-index for NavBar */
`;
...
const PostFeedSeeAll: FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axiosInstance.get(`${process.env.REACT_APP_API_BASE_URL}/mypage/posts/feeds/communities`);
